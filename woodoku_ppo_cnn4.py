...
def parse_args():
    ...
    parser.add_argument("--wandb-project-name", type=str, default="Woodoku",
    ...
    # track interval
    parser.add_argument("--log-charts-interval", type=int, default=10000,
    ...
    parser.add_argument("--record-interval", type=int, default=1000000,
        help="Record interval for RecordVideo")


    # Algorithm specific arguments
    parser.add_argument("--env-id", type=str, default="gym_woodoku/Woodoku-v0",
